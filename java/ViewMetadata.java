...
public class ViewMetadata extends JFrame implements ActionListener
{
...
setTitle("MetaData::A Blockchain Approach to Ensuring Provenance to Outsourced Cloud Data in a Sharing Ecosystem");
c= getContentPane();
...
try {
	 ...
	 heading.addElement("Stakeholder");
			  ...
			  Vector data=new Vector();
	             ...
	             String query = "SELECT * from Bootstrap";
