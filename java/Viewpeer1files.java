...
public class Viewpeer1files extends JFrame implements ActionListener
{
...
setTitle("SH1 Files::A Blockchain Approach to Ensuring Provenance to Outsourced Cloud Data in a Sharing Ecosystem");
c= getContentPane();
...
try {
	 ...
	 heading.addElement("Sk");
	             ...
	             String query = "SELECT * from Normalpeer1";
